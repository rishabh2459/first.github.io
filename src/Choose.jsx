  ...
  return (
    <>
      ...
      <div className="row gy-5 ">
        ...
        <div className="p-5 mb-2 bg-info text-dark position-relative">
          <div className="position-absolute top-50 start-50 translate-middle">
            <div className="height-100 weidth=50 container d-flex justify-content-center align-items-center">
              <div className="card p-3 p-3 mb-2 bg-info text-dark">
              ...
              <div class="col">
                <div class="card h-100">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text">
                      Become part of a fun non judgemental, friendly and super
              ...
              <div class="col">
                <div class="card h-100">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text">
                      Finally end the frustration of searching for a fitness
                      regime that you can enjoy and feel at ease with. Start
                      seeing the results you have always wanted to achieve, with
                      your fitness and with weight loss.
                    </p>
                  </div>
                </div>
              </div>
